...
export default function NewClaimPage() {
  ...
  useEffect(()=>{
    getPatients(companyId||undefined).then(setPatients);
    getProviders(companyId||undefined).then(setProviders);
  },[companyId]);
        ...
        <div style={{display:"grid",gridTemplateColumns:"2fr 1fr",gap:24}}>
          <div style={{display:"flex",flexDirection:"column",gap:20}}>
            ...
            <div className="data-card" style={{padding:28}}>
              ...
              <textarea className="form-input" rows={3} placeholder="Additional notes..." value={form.notes} onChange={set("notes")} style={{resize:"vertical"}}/>
            </div>
          </div>
          ...
          <div style={{display:"flex",flexDirection:"column",gap:16}}>
            <div className="data-card" style={{padding:24}}>
              ...
              {[["Patient",form.patientName||"—"],["Provider",form.providerName||"—"],["Date",form.serviceDate||"—"],["Status",form.status],["Procedures",form.procedureCodes.length],["Diagnosis",form.diagnosisCodes.filter(Boolean).length+" codes"]].map(([k,v])=>(
