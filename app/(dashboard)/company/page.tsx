  ...
  return (
    <div className="dash-content">
      ...
      <div className="stat-grid" style={{ marginBottom: 24 }}>
        {[
          { icon: "🏥", label: "Providers",    val: providers.length, color: "var(--blue2)" },
          { icon: "👤", label: "Patients",     val: patients.length,  color: "var(--cyan)"  },
          { icon: "📋", label: "Claims",       val: claims.length,    color: "var(--white)" },
      ...
      <div style={{ display: "grid", gridTemplateColumns: "2fr 1fr", gap: 24 }}>
        <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
          ...
          <div className="data-card" style={{ padding: 24 }}>
            ...
            {[
              { href: "/providers", icon: "🏥", label: "Manage Providers", sub: `${providers.length} providers` },
              { href: "/patients",  icon: "👤", label: "Manage Patients",  sub: `${patients.length} patients`  },
              { href: "/claims",    icon: "📋", label: "View Claims",      sub: `${claims.length} total claims` },
