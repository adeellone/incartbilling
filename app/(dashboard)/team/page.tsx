...
const ROLE_BADGE:Record<UserRole,string>={superadmin:"badge-cyan",company_admin:"badge-blue",billing_staff:"badge-gray",provider:"badge-green"};
const ROLE_LABEL:Record<UserRole,string>={superadmin:"Super Admin",company_admin:"Company Admin",billing_staff:"Billing Staff",provider:"Provider (read-only)"};
...
export default function TeamPage() {
  ...
  const handleAdd=async(e:React.FormEvent)=>{
    ...
    try {
      ...
      // Use secondary app so current session is NOT replaced
  ...
  return (
    <div className="dash-content">
      ...
      <div className="data-card">
        ...
        {loading?(<div style={{padding:32,textAlign:"center",color:"var(--muted)"}}>Loading team...</div>)
        :users.length===0?(
          <div className="empty"><div className="empty-icon">👥</div><div className="empty-title">No team members yet</div><div className="empty-sub">Invite your billing staff to get started</div></div>
        ):(
          <table className="tbl">
