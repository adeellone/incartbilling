...
export default function ProviderPaymentsPage() {
  ...
  useEffect(()=>{
    ...
    getDocs(q).then(snap=>{ setPayments(snap.docs.map(d=>({id:d.id,...d.data()}as Payment))); setLoading(false); });
  ...
  return(
    <div className="dash-content">
      <div style={{marginBottom:28}}><h1 className="sora" style={{fontSize:24,fontWeight:800}}>My Payments</h1><p style={{color:"var(--muted)",fontSize:13,marginTop:4}}>Payments collected on your behalf</p></div>
      ...
      <div className="data-card">
        ...
        :payments.length===0?(<div className="empty"><div className="empty-icon">💰</div><div className="empty-title">No payments yet</div></div>):(
          <table className="tbl">
