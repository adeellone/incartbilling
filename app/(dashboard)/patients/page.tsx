...
export default function PatientsPage() {
  ...
  const load = () =>
    getPatients(companyId || undefined).then((p) => {
      setPatients(p);
      setFiltered(p);
      setLoading(false);
    });
          ...
          <form className="panel" onSubmit={handleAdd}>
            ...
            <div className="form-row">
              <div className="form-group">
                ...
                <input className="form-input" value={form.insurance.planName} onChange={setIns("planName")} />
              </div>
              <div className="form-group">
                <label className="form-label">PAYER</label>
                <input className="form-input" value={form.insurance.payer} onChange={setIns("payer")} />
              </div>
            </div>
            ...
            <div className="form-row">
              <div className="form-group">
                ...
                <input className="form-input" value={form.insurance.memberId} onChange={setIns("memberId")} />
              </div>
              <div className="form-group">
                <label className="form-label">GROUP NUMBER</label>
                <input className="form-input" value={form.insurance.groupNumber} onChange={setIns("groupNumber")} />
              </div>
            </div>
          ...
          <table className="tbl">
            ...
            <tbody>
              {filtered.map((p) => (
                <tr key={p.id}>
                  <td>
                    <a href={`/patients/${p.id}`} className="tbl-link">
                  ...
                  <td style={{ fontSize: 13, fontFamily: "monospace", color: "var(--muted)" }}>
