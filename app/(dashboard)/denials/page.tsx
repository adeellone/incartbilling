...
const AB: Record<AppealStatus, string> = {
  not_started: "badge-gray", in_progress: "badge-yellow", won: "badge-green", lost: "badge-red",
};
const AL: Record<AppealStatus, string> = {
  not_started: "Not Started", in_progress: "In Progress", won: "Won", lost: "Lost",
};
...
export default function DenialsPage() {
  ...
  const [form, setForm] = useState<Omit<Denial, "id" | "createdAt" | "companyId">>({
    claimId: "", patientName: "", reasonCode: "CO-4", reasonDesc: REASONS["CO-4"],
    deniedAmount: 0, appealStatus: "not_started", dueDate: "", notes: "",
  });
    ...
    <div className="dash-content">
      ...
      <div className="data-card">
        ...
        {loading ? (
          ...
          <div className="empty"><div className="empty-icon">🚫</div><div className="empty-title">No denials logged</div></div>
        ) : (
          <table className="tbl">
